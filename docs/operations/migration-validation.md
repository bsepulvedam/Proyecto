...
- [CONFIRMADO GATE 4B-3B 2026-09-02] En `boliklor_ot_test` se validaron `empty → 20260902_09` dentro de un esquema temporal eliminado tras el éxito y `20260901_08 → 20260902_09` sobre el esquema desechable habitual. Se comprobaron 24 tablas ORM, seed global de $30.000 desde `2026-09-01`, paridad Alembic, mapeo reversible de incidencias, constraints/FKs/índices, locks y concurrencia con exactamente una salida/decisión/tarifa. El downgrade rechazó atómicamente intervenciones y versiones adicionales de tarifa; la base quedó en `20260902_09 (head)` sin fixtures 4B-3B y `alembic check` limpio.
